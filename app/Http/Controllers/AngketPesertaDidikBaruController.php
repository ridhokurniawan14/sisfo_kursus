...
class AngketPesertaDidikBaruController extends Controller
{
    ...
    public function destroy(AngketPesertaDidikBaru $angketPesertaDidikBaru)
    {
        if ($angketPesertaDidikBaru->exists()) {
            ...
            return redirect('/admin/angket-peserta-didik-baru')->with('message', 'Data Berhasil Dihapus!');
        } else {
            return redirect('/admin/angket-peserta-didik-baru')->with('error', 'Data Tidak Ditemukan!');
        }
    }
}
