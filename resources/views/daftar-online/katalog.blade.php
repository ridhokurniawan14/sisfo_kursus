    ...
    <div class="container text-light">
        <div class="w-100 d-flex justify-content-between">
            <div>
                ...
                <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:{{ config('app.email', 'info@company.com') }}">
                    {{ config('app.email', 'info@company.com') }}
                </a>
                <i class="fa fa-phone mx-2"></i>
                <a class="navbar-sm-brand text-light text-decoration-none" href="tel:{{ config('app.phone', '010-020-0340') }}">
                    {{ config('app.phone', '010-020-0340') }}
                </a>
            </div>
            <div>
...
@endif
    ...
    {{-- paket1 --}}
   @php
    $images = ['paket1.jpg', 'paket2.jpg', 'paket3.jpg', 'paket4.jpg'];
@endphp
    ...
    <div class="col-12 col-md-3 mb-4 d-flex justify-content-center">
        <div class="card h-100" style="max-width: 300px; width: 100%;">
            <a href="{{ url('/daftar-online?program=' . urlencode($data->program_pilihan) . '&harga=' . $data->harga.'&code='.$data->id.'&pil_prog='.'paket') }}">
                ...
                @endphp
                <img src="{{ asset('assets/img/' . $image) }}" class="card-img-top" alt="Gambar Paket Kursus" />
            </a>
            <div class="card-body">
                {{-- <a href="{{ url('/daftar-online') }}" class="h2 text-decoration-none text-dark">
                    {{ $data->kode }}
                </a> --}}
                <p class="card-text">
                    Program: {{ $data->program_pilihan }}
                </p>
                ...
                <ul class="list-unstyled d-flex justify-content-between">
                    ...
                    <li class="text-muted text-right">Rp {{ number_format($data->harga, 0, ',', '.') }}</li>
                </ul>
            </div>
        </div>
    </div>
      ...
      <div class="container py-5">
        <div class="row text-center py-3">
          <div class="col-lg-6 m-auto">
            <h1 class="h1">PROGRAM PILIHAN</h1>
            <p>
        ...
        <div class="card h-100">
         <a href="{{ url('/daftar-online?program=' . urlencode($program->program) . '&harga=' . $program->harga.'&pilihan='.$data->id.'&pil_prog='.'piihan') }}">
                ...
                {{-- @php
                    ...
                    $images = ['word.jpg', 'excel.jpg', 'acces.jpg'];
                    $image = $images[$index % count($images)];
                @endphp
            ...
            <div class="card-body">
               <a href="{{ url('/daftar-online?program=' . urlencode($program->program) . '&harga=' . $program->harga.'&pilihan='.$data->id.'&pil_prog='.'pilihan') }}" class="h2 text-decoration-none text-dark">
                ...
                <p class="card-text">
                    Program kursus {{ ucwords($program->program) }} untuk meningkatkan keterampilan Anda.
                </p>
                ...
                <ul class="list-unstyled d-flex justify-content-between">
                    ...
                    <li class="text-muted text-right">Rp {{ number_format($program->harga, 0, ',', '.') }}</li>
                </ul>
            </div>
        </div>
    </div>
