            ...
            <div class="row">
                <div class="col-12 col-sm-12">
                    <div class="card card-primary card-tabs">
                        ...
                        <form method="POST" action="{{ route('pendaftar-online.store', ['id' => $id]) }}"
                                ...
                                <div class="tab-content" id="custom-tabs-two-tabContent">
                                    <div class="tab-pane fade show active" id="custom-tabs-two-home" role="tabpanel"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input
                                                        value="{{ old('nm_lengkap', ucwords($pendaftar_online->nm_lengkap)) }}"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="tmp_lahir" class="col-sm-12 col-form-label">Tempat Lahir
                                                        <span class="text-danger">*</span></label>
                                                    <input
                                                        value="{{ old('tmp_lahir', ucwords($pendaftar_online->tmp_lahir)) }}"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="tgl_lahir" class="col-sm-12 col-form-label">Tanggal Lahir
                                                        <span class="text-danger">*</span></label>
                                                    <input value="{{ old('tgl_lahir', $pendaftar_online->tgl_lahir) }}"
                                                        required type="date" name="tgl_lahir"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="gender" id="gender"
                                                        ...
                                                        required>
                                                        <option value=""
                                                            {{ old('gender', $pendaftar_online->gender) == '' ? 'selected' : '' }}>
                                                            Pilih Jenis Kelamin</option>
                                                        <option value="l"
                                                            {{ in_array(old('gender', $pendaftar_online->gender), ['l', 'L']) ? 'selected' : '' }}>
                                                            Laki-laki</option>
                                                        <option value="p"
                                                            {{ in_array(old('gender', $pendaftar_online->gender), ['p', 'P']) ? 'selected' : '' }}>
                                                            Perempuan</option>
                                                        <select>
                                                            @error('gender')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="agama" id="agama"
                                                        ...
                                                        @foreach (['Islam', 'Kristen/Katolik', 'Hindu', 'Budha', 'Khonghucu', 'Lainnya'] as $agama)
                                                            <option value="{{ $agama }}"
                                                                {{ old('agama', $pendaftar_online->agama) == $agama ? 'selected' : '' }}>
                                                                {{ $agama }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('agama')
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="kewarganegaraan" class="custom-select" required>
                                                        <option value=""
                                                            {{ old('kewarganegaraan', $pendaftar_online->kewarganegaraan) == '' ? 'selected' : '' }}>
                                                            Pilih Kewarganegaraan</option>
                                                        <option value="wni"
                                                            {{ in_array(old('kewarganegaraan', $pendaftar_online->kewarganegaraan), ['wni', 'WNI']) ? 'selected' : '' }}>
                                                            Warga Negara Indonesia (WNI)</option>
                                                        <option value="wna"
                                                            {{ in_array(old('kewarganegaraan', $pendaftar_online->kewarganegaraan), ['wna', 'WNA']) ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="pend_akhir"
                                                        ...
                                                        @foreach (['' => 'Pilih Pendidikan Terakhir', 'tidak sekolah' => 'Tidak Sekolah', 'sd' => 'SD', 'smp' => 'SMP', 'SLTA' => 'SLTA', 'd3' => 'D3', 'S1' => 'D4/S1', 's2' => 'S2', 's3' => 'S3'] as $value => $label)
                                                            <option value="{{ $value }}"
                                                                {{ old('pend_akhir', $pendaftar_online->pend_akhir) == $value ? 'selected' : '' }}>
                                                                {{ $label }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('pend_akhir')
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('no_hp', $pendaftar_online->no_hp) }}"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="status_pekerjaan" id="status_pekerjaan"
                                                        ...
                                                        required>
                                                        <option value=""
                                                            {{ old('status_pekerjaan', $pendaftar_online->status_pekerjaan) == '' ? 'selected' : '' }}>
                                                        ...
                                                        @foreach (['pelajar', 'mahasiswa', 'tidak bekerja', 'nelayan', 'petani', 'peternak', 'pns/tni/polri', 'guru', 'karyawan swasta', 'pedagang/wiraswasta', 'buruh', 'pensiunan', 'lainnya'] as $option)
                                                            <option value="{{ $option }}"
                                                                {{ old('status_pekerjaan', $pendaftar_online->status_pekerjaan) == $option ? 'selected' : '' }}>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="tgl_masuk" class="col-sm-12 col-form-label">Tanggal Daftar
                                                        <span class="text-danger">*</span></label>
                                                    <input value="{{ old('tgl_masuk', $pendaftar_online->tgl_daftar) }}"
                                                        readonly type="date" name="tgl_masuk"
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="{{ route('pendaftar-online.index') }}"><button type="button"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="alamat" class="col-sm-12 col-form-label">Alamat Lengkap
                                                        <span class="text-danger">*</span></label>
                                                    <input value="{{ old('alamat', ucwords($pendaftar_online->alamat)) }}"
                                                        autofocus required type="text" name="alamat"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('kab') }}" type="text" name="kab"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="provinsi" id="provinsi"
                                                        ...
                                                        @foreach ($provinces as $value => $label)
                                                            <option value="{{ $value }}"
                                                                {{ old('provinsi', $pendaftar_online->provinsi) == $value ? 'selected' : '' }}>
                                                                {{ $label }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('provinsi')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="jns_tinggal" id="jns_tinggal"
                                                        ...
                                                        @foreach ($jenisTinggal as $value => $label)
                                                            <option value="{{ $value }}"
                                                                {{ old('jns_tinggal', $pendaftar_online->jns_tinggal) == $value ? 'selected' : '' }}>
                                                                {{ $label }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('jns_tinggal')
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="nm_ayah" class="col-sm-12 col-form-label">Nama
                                                        Ayah</label>
                                                    <input
                                                        value="{{ old('nm_ayah', ucwords($pendaftar_online->nm_ortu)) }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="pend_ayah"
                                                        ...
                                                        @foreach ($pendidikanAyah as $value => $label)
                                                            <option value="{{ $value }}"
                                                                {{ old('pend_ayah', $pendaftar_online->pend_ayah) == $value ? 'selected' : '' }}>
                                                                {{ $label }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('pend_ayah')
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="pek_ayah" id="pek_ayah"
                                                        ...
                                                        required>
                                                        <option value=""
                                                            {{ old('pek_ayah', $pendaftar_online->pek_ortu) == '' ? 'selected' : '' }}>
                                                            Pilih Pekerjaan</option>
                                                        @foreach (['pelajar', 'mahasiswa', 'tidak bekerja', 'nelayan', 'petani', 'peternak', 'pns/tni/polri', 'guru', 'karyawan swasta', 'pedagang/wiraswasta', 'buruh', 'pensiunan', 'lainnya'] as $option)
                                                            <option value="{{ $option }}"
                                                                {{ old('pek_ayah', $pendaftar_online->pek_ortu) == $option ? 'selected' : '' }}>
                                                                {{ ucwords($option) }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('pek_ayah')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="pend_ibu"
                                                        ...
                                                        @foreach ($pendidikanIbu as $value => $label)
                                                            <option value="{{ $value }}"
                                                                {{ old('pend_ibu', $pendaftar_online->pend_ibu) == $value ? 'selected' : '' }}>
                                                                {{ $label }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('pend_ibu')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="pek_ibu" id="pek_ibu"
                                                        ...
                                                        @foreach ($pekerjaanIbu as $value => $label)
                                                            <option value="{{ $value }}"
                                                                {{ old('pek_ibu', $pendaftar_online->pek_ibu) == $value ? 'selected' : '' }}>
                                                                {{ $label }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('pek_ibu')
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="alamat_ortu" class="col-sm-12 col-form-label">Alamat Orang
                                                        Tua</label>
                                                    <input
                                                        value="{{ old('alamat_ortu', ucwords($pendaftar_online->alamat_ortu)) }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="pend_wali"
                                                        ...
                                                        @foreach ($pendidikanWali as $value => $label)
                                                            <option value="{{ $value }}"
                                                                {{ old('pend_wali', $pendaftar_online->pend_wali) == $value ? 'selected' : '' }}>
                                                                {{ $label }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('pend_wali')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="pek_wali" id="pek_wali"
                                                        ...
                                                        @foreach ($pekerjaanWali as $value => $label)
                                                            <option value="{{ $value }}"
                                                                {{ old('pek_wali', $pendaftar_online->pek_wali) == $value ? 'selected' : '' }}>
                                                                {{ $label }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('pek_wali')
