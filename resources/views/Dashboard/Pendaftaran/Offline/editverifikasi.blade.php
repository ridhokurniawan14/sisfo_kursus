...
@section('container')
    ...
    <section class="content">
      <form method="POST" action="{{ route('pendaftaran.UpdateVerifikasi', ['no_induk' => $no_induk]) }}" class="form-horizontal" enctype="multipart/form-data">
      @method('put')
      @csrf
                      ...
                      <label for="kd_jam" class="col-sm-12 col-form-label">Jam Kursus <span class="text-danger">*</span></label>
                        <select autofocus name="kd_jam" class="custom-select">
                          ...
                          @foreach ($categories as $category)
                            <option required value="{{ $category->id }}" {{ old('kd_jam', $pendaftar->kd_jam) == $category->id ? 'selected' : '' }}>
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input custom-control-input-danger" type="radio" value="paket" id="customRadio5" name="pil_prog" 
                                {{ $pendaftar->pil_prog == 'paket' ? 'checked' : '' }} onclick="toggleProgram(this.value)">
                            <label for="customRadio5" class="custom-control-label">Paket</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input custom-control-input-danger" type="radio" value="pilihan" id="customRadio4" name="pil_prog" 
                                {{ $pendaftar->pil_prog == 'pilihan' ? 'checked' : '' }} onclick="toggleProgram(this.value)">
                        ...
                        <label for="kd_pilihan1" class="col-sm-12 col-form-label">Program Pilihan 1<span class="text-danger">*</span></label>
                          <select autofocus name="kd_pilihan1" class="custom-select" id="kd_pilihan1" onchange="hitungBiaya()">
                            ...
                            @foreach ($program_pilihan as $prog_pil)
                              <option data-price="{{ $prog_pil->harga }}" required value="{{ $prog_pil->id }}" {{ old('kd_pilihan1',$pendaftar->kd_pilihan1) == $prog_pil->id ? 'selected' : '' }}>
                      ...
                      <div class="form-group">
                        <label for="kd_pilihan2" class="col-sm-12 col-form-label">Program Pilihan 2</label>
                          <select name="kd_pilihan2" class="custom-select" id="kd_pilihan2" onchange="hitungBiaya()">
                            <option value="0">Pilih Program</option>
                            @foreach ($program_pilihan as $prog_pil)
                              <option data-price="{{ $prog_pil->harga }}" required value="{{ $prog_pil->id }}" {{ old('kd_pilihan2',$pendaftar->kd_pilihan2) == $prog_pil->id ? 'selected' : '' }}>
                                  {{ ucwords($prog_pil->program) }} - (Rp. {{ number_format($prog_pil->harga) }})</option>
                            @endforeach
                          </select>
                          @error('kd_pilihan2')
                      ...
                      <div class="form-group">
                        <label for="kd_pilihan3" class="col-sm-12 col-form-label">Program Pilihan 3</label>
                          <select name="kd_pilihan3" class="custom-select" id="kd_pilihan3" onchange="hitungBiaya()">
                            <option value="0">Pilih Program</option>
                            @foreach ($program_pilihan as $prog_pil)
                              <option data-price="{{ $prog_pil->harga }}" required value="{{ $prog_pil->id }}" {{ old('kd_pilihan3',$pendaftar->kd_pilihan3) == $prog_pil->id ? 'selected' : '' }}>
                                  {{ ucwords($prog_pil->program) }} - (Rp. {{ number_format($prog_pil->harga) }})</option>
                            @endforeach
                          </select>
                          @error('kd_pilihan3')
                      ...
                      <div class="form-group">
                        <label for="kd_pilihan4" class="col-sm-12 col-form-label">Program Pilihan 4</label>
                          <select name="kd_pilihan4" class="custom-select" id="kd_pilihan4" onchange="hitungBiaya()">
                            <option value="0">Pilih Program</option>
                            @foreach ($program_pilihan as $prog_pil)
                              <option data-price="{{ $prog_pil->harga }}" required value="{{ $prog_pil->id }}" {{ old('kd_pilihan4',$pendaftar->kd_pilihan4) == $prog_pil->id ? 'selected' : '' }}>
                                  {{ ucwords($prog_pil->program) }} - (Rp. {{ number_format($prog_pil->harga) }})</option>
                            @endforeach
                          </select>
                          @error('kd_pilihan4')
                      ...
                      <div class="form-group">
                        <label for="kd_pilihan5" class="col-sm-12 col-form-label">Program Pilihan 5</label>
                          <select name="kd_pilihan5" class="custom-select" id="kd_pilihan5" onchange="hitungBiaya()">
                            <option value="0">Pilih Program</option>
                            @foreach ($program_pilihan as $prog_pil)
                              <option data-price="{{ $prog_pil->harga }}" required value="{{ $prog_pil->id }}" {{ old('kd_pilihan5',$pendaftar->kd_pilihan5) == $prog_pil->id ? 'selected' : '' }}>
                                  {{ ucwords($prog_pil->program) }} - (Rp. {{ number_format($prog_pil->harga) }})</option>
                            @endforeach
                          </select>
                          @error('kd_pilihan5')
                      ...
                      <div class="form-group">
                        <label for="kd_pilihan6" class="col-sm-12 col-form-label">Program Pilihan 6</label>
                          <select name="kd_pilihan6" class="custom-select" id="kd_pilihan6" onchange="hitungBiaya()">
                            <option value="0">Pilih Program</option>
                            @foreach ($program_pilihan as $prog_pil)
                              <option data-price="{{ $prog_pil->harga }}" required value="{{ $prog_pil->id }}" {{ old('kd_pilihan6',$pendaftar->kd_pilihan6) == $prog_pil->id ? 'selected' : '' }}>
                                  {{ ucwords($prog_pil->program) }} - (Rp. {{ number_format($prog_pil->harga) }})</option>
                            @endforeach
                          </select>
                          @error('kd_pilihan6')
                      ...
                      <div class="form-group">
                        ...
                        <select id="kd_paket" name="kd_paket" class="custom-select">
                          ...
                          @foreach ($program_paket as $prog_pak)
                            <option data-price="{{ $prog_pak->harga }}" value="{{ $prog_pak->id }}" {{ old('kd_paket',$pendaftar->kd_paket) == $prog_pak->id ? 'selected' : '' }}>
                    ...
                    <div class="col-sm-2"> 
                      <div class="form-group">
                        ...
                        <select id="kd_tambahan" name="kd_tambahan" class="custom-select">
                          <option value="0">Pilih Program</option>
                          @foreach ($program_pilihan as $prog_pil)
                            <option data-price="{{ $prog_pil->harga }}" value="{{ $prog_pil->id }}" {{ old('kd_tambahan',$pendaftar->kd_tambahan) == $prog_pil->id ? 'selected' : '' }}>
                    ...
                    <div class="col-sm-2"> 
                      <div class="form-group">
                        ...
                        <select id="kd_tambahan2" name="kd_tambahan2" class="custom-select">
                          <option value="0">Pilih Program</option>
                          @foreach ($program_pilihan as $prog_pil)
                            <option data-price="{{ $prog_pil->harga }}" value="{{ $prog_pil->id }}" {{ old('kd_tambahan2',$pendaftar->kd_tambahan2) == $prog_pil->id ? 'selected' : '' }}>
                              {{ ucwords($prog_pil->program) }} - (Rp. {{ number_format($prog_pil->harga) }})
                            </option>
                          @endforeach
                        </select>
                    ...
                    <div class="col-sm-2"> 
                      <div class="form-group">
                        ...
                        <select id="kd_tambahan3" name="kd_tambahan3" class="custom-select">
                          <option value="0">Pilih Program</option>
                          @foreach ($program_pilihan as $prog_pil)
                            <option data-price="{{ $prog_pil->harga }}" value="{{ $prog_pil->id }}" {{ old('kd_tambahan3',$pendaftar->kd_tambahan3) == $prog_pil->id ? 'selected' : '' }}>
                              {{ ucwords($prog_pil->program) }} - (Rp. {{ number_format($prog_pil->harga) }})
                            </option>
                          @endforeach
                        </select>
                    ...
                    <div class="col-sm-2"> 
                      <div class="form-group">
                        ...
                        <select id="kd_tambahan4" name="kd_tambahan4" class="custom-select">
                          <option value="0">Pilih Program</option>
                          @foreach ($program_pilihan as $prog_pil)
                            <option data-price="{{ $prog_pil->harga }}" value="{{ $prog_pil->id }}" {{ old('kd_tambahan4',$pendaftar->kd_tambahan4) == $prog_pil->id ? 'selected' : '' }}>
                              {{ ucwords($prog_pil->program) }} - (Rp. {{ number_format($prog_pil->harga) }})
                            </option>
                          @endforeach
                        </select>
        ...
        <div class="invoice p-3 mb-3">
              ...
              <table class="table table-striped">
                ...
                <tbody id="angsuranTableBody">
                  ...
                  <tr>
                    ...
                    <td></td>
                    <td colspan="2">
                      <input value="{{ number_format($pendaftar->discount, 0, '', '.') }}" required type="text" name="discount" class="form-control form-control-sm @error('discount') is-invalid @enderror" id="discount" placeholder="Isi Discount" onkeyup="formatRupiah(this); calculateKekurangan();">
                      @error('discount')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <tr>
                    ...
                    <td></td>
                    <td colspan="2">
                      <input value="{{ number_format($pendaftar->tot_biaya, 0, '', '.') }}" readonly required type="text" name="tot_biaya" class="form-control form-control-sm @error('tot_biaya') is-invalid @enderror" id="tot_biaya" placeholder="Otomatis">
                      @error('tot_biaya')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <tr>
                    ...
                    <td colspan="2">
                      <input value="{{ number_format($pendaftar->angsuran1, 0, '', '.') }}" required type="text" name="angsuran1" class="form-control form-control-sm @error('angsuran1') is-invalid @enderror" id="angsuran1" placeholder="Pembayaran Awal" onkeyup="formatRupiah(this); calculateKekurangan();">
                      @error('angsuran1')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <tr>
                    ...
                    <td>Angsuran ke 2 </td>
                    <td>
                      <input value="{{ $pendaftar->tgl_angsuran2 }}"  type="date" name="tgl_angsuran2" class="form-control form-control-sm @error('tgl_angsuran2') is-invalid @enderror" id="tgl_angsuran2" placeholder="Tanggal Lahir">
                      @error('tgl_angsuran2')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                    ...
                    <td colspan="2">
                      <input value="{{ number_format($pendaftar->angsuran2, 0, '', '.') }}" type="text" name="angsuran2" class="form-control form-control-sm @error('angsuran2') is-invalid @enderror" id="angsuran2" placeholder="" onkeyup="formatRupiah(this); calculateKekurangan();">
                      @error('angsuran2')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <tr>
                    ...
                    <td>Angsuran ke 3 </td>
                    <td>
                      <input value="{{ $pendaftar->tgl_angsuran3 }}"  type="date" name="tgl_angsuran3" class="form-control form-control-sm @error('tgl_angsuran3') is-invalid @enderror" id="tgl_angsuran3" placeholder="Tanggal Lahir">
                      @error('tgl_angsuran3')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                    ...
                    <td colspan="2">
                      <input value="{{ number_format($pendaftar->angsuran3, 0, '', '.') }}" type="text" name="angsuran3" class="form-control form-control-sm @error('angsuran3') is-invalid @enderror" id="angsuran3" placeholder="" onkeyup="formatRupiah(this); calculateKekurangan();">
                      @error('angsuran3')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <tr>
                    ...
                    <td>Angsuran ke 4 </td>
                    <td>
                      <input value="{{ $pendaftar->tgl_angsuran4 }}"  type="date" name="tgl_angsuran4" class="form-control form-control-sm @error('tgl_angsuran4') is-invalid @enderror" id="tgl_angsuran4" placeholder="Tanggal Lahir">
                      @error('tgl_angsuran4')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                    ...
                    <td colspan="2">
                      <input value="{{ number_format($pendaftar->angsuran4, 0, '', '.') }}" type="text" name="angsuran4" class="form-control form-control-sm @error('angsuran4') is-invalid @enderror" id="angsuran4" placeholder="" onkeyup="formatRupiah(this); calculateKekurangan();">
                      @error('angsuran4')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <tr>
                    ...
                    <td>Angsuran ke 5 </td>
                    <td>
                      <input value="{{ $pendaftar->tgl_angsuran5 }}"  type="date" name="tgl_angsuran5" class="form-control form-control-sm @error('tgl_angsuran5') is-invalid @enderror" id="tgl_angsuran5" placeholder="Tanggal Lahir">
                      @error('tgl_angsuran5')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                    ...
                    <td colspan="2">
                      <input value="{{ number_format($pendaftar->angsuran5, 0, '', '.') }}" type="text" name="angsuran5" class="form-control form-control-sm @error('angsuran5') is-invalid @enderror" id="angsuran5" placeholder="" onkeyup="formatRupiah(this); calculateKekurangan();">
                      @error('angsuran5')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
              ...
              <div class="table-responsive">
                <table class="table">
                  <tr>
                    ...
                    <td style="width:35%">
                      <input value="{{ number_format($pendaftar->kekurangan, 0, '', '.') }}" readonly required type="text" name="kekurangan" class="form-control @error('kekurangan') is-invalid @enderror" id="kekurangan" placeholder="Otomatis" style="flex: 1;">
                      @error('kekurangan')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
          ...
          <div class="row no-print">
            <div class="col-12">
              ...
              <button type="submit" class="btn btn-info float-right">Perbarui</button>
              <button type="reset" class="btn btn-default float-right mr-2" onclick="refreshPage()">Reset</button>
            </div>
          </div>
        </div>        
        <!-- /.row -->
    ...
    <script>
      ...
      function toggleProgram(value) {
        ...
        if (value === 'paket') {
          ...
          // Set nilai null untuk semua select di dalam program-pilihan
          resetSelectValues('program-pilihan');
        } else {
          programPaket.style.display = 'none';
          programPilihan.style.display = 'block';
          // Set nilai null untuk semua select di dalam program-paket
          resetSelectValues('program-paket');
        }
        hitungBiaya(); // Recalculate biaya when program type is toggled
      }
      // Fungsi untuk mengatur nilai null pada semua select di dalam sebuah div
      function resetSelectValues(divId) {
      ...
      // Event listener untuk memanggil toggleProgram ketika input pil_prog berubah
document.querySelectorAll('input[name="pil_prog"]').forEach(input => {
    input.addEventListener('change', function() {
        toggleProgram(this.value);
    });
});

// Pemanggilan toggleProgram saat halaman dimuat jika ada input yang sudah dicentang
const pilProgChecked = document.querySelector('input[name="pil_prog"]:checked');
if (pilProgChecked) {
    toggleProgram(pilProgChecked.value);
}
