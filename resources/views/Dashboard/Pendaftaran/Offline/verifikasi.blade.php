...
@section('container')
    ...
    <section class="content">
        <form method="POST" action="{{ route('pendaftaran.SaveVerifikasi', ['no_induk' => $no_induk]) }}"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="no_induk" class="col-sm-12 col-form-label">NIS (Nomor Induk
                                                Siswa)</label>
                                            <input value="{{ $pendaftar->no_induk }}" readonly required type="text"
                                                name="no_induk" class="form-control @error('no_induk') is-invalid @enderror"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ ucwords($pendaftar->nm_lengkap) }}" readonly required
                                                type="text" name="nm_lengkap"
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label for="pil_prog" class="col-sm-12 col-form-label">Program <span
                                                    class="text-danger">*</span></label>
                                            <div class="custom-control custom-radio">
                                                <input class="custom-control-input custom-control-input-danger"
                                                    type="radio" value="paket" id="customRadio5" name="pil_prog"
                                                    onclick="toggleProgram(this.value)">
                                                <label for="customRadio5" class="custom-control-label">Paket</label>
                                            </div>
                                            <div class="custom-control custom-radio">
                                                <input class="custom-control-input custom-control-input-danger"
                                                    type="radio" value="pilihan" id="customRadio4" name="pil_prog"
                                                    onclick="toggleProgram(this.value)">
                                ...
                                <div id="program-pilihan" style="display:none;">
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="kd_pilihan1" class="col-sm-12 col-form-label">Program Pilihan
                                                    1<span class="text-danger">*</span></label>
                                                <select autofocus name="kd_pilihan1" class="custom-select" id="kd_pilihan1"
                                                    onchange="hitungBiaya()">
                                                    <option value="0">Pilih Program</option>
                                                    @foreach ($program_pilihan as $prog_pil)
                                                        <option data-price="{{ $prog_pil->harga }}" required
                                                            value="{{ $prog_pil->id }}"
                                                            {{ old('kd_pilihan1') == $prog_pil->id ? 'selected' : '' }}>
                                                            {{ ucwords($prog_pil->program) }} - (Rp.
                                                            {{ number_format($prog_pil->harga) }})</option>
                                                    @endforeach
                                                </select>
                                                @error('kd_pilihan1')
                                                    <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="kd_pilihan2" class="col-sm-12 col-form-label">Program Pilihan
                                                    2</label>
                                                <select name="kd_pilihan2" class="custom-select" id="kd_pilihan2"
                                                    onchange="hitungBiaya()">
                                                    <option value="0">Pilih Program</option>
                                                    @foreach ($program_pilihan as $prog_pil)
                                                        <option data-price="{{ $prog_pil->harga }}" required
                                                            value="{{ $prog_pil->id }}"
                                                            {{ old('kd_pilihan2') == $prog_pil->id ? 'selected' : '' }}>
                                                            {{ ucwords($prog_pil->program) }} - (Rp.
                                                            {{ number_format($prog_pil->harga) }})</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="kd_pilihan3" class="col-sm-12 col-form-label">Program Pilihan
                                                    3</label>
                                                <select name="kd_pilihan3" class="custom-select" id="kd_pilihan3"
                                                    onchange="hitungBiaya()">
                                                    <option value="0">Pilih Program</option>
                                                    @foreach ($program_pilihan as $prog_pil)
                                                        <option data-price="{{ $prog_pil->harga }}" required
                                                            value="{{ $prog_pil->id }}"
                                                            {{ old('kd_pilihan3') == $prog_pil->id ? 'selected' : '' }}>
                                                            {{ ucwords($prog_pil->program) }} - (Rp.
                                                            {{ number_format($prog_pil->harga) }})</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="kd_pilihan4" class="col-sm-12 col-form-label">Program Pilihan
                                                    4</label>
                                                <select name="kd_pilihan4" class="custom-select" id="kd_pilihan4"
                                                    onchange="hitungBiaya()">
                                                    <option value="0">Pilih Program</option>
                                                    @foreach ($program_pilihan as $prog_pil)
                                                        <option data-price="{{ $prog_pil->harga }}" required
                                                            value="{{ $prog_pil->id }}"
                                                            {{ old('kd_pilihan4') == $prog_pil->id ? 'selected' : '' }}>
                                                            {{ ucwords($prog_pil->program) }} - (Rp.
                                                            {{ number_format($prog_pil->harga) }})</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="kd_pilihan5" class="col-sm-12 col-form-label">Program Pilihan
                                                    5</label>
                                                <select name="kd_pilihan5" class="custom-select" id="kd_pilihan5"
                                                    onchange="hitungBiaya()">
                                                    <option value="0">Pilih Program</option>
                                                    @foreach ($program_pilihan as $prog_pil)
                                                        <option data-price="{{ $prog_pil->harga }}" required
                                                            value="{{ $prog_pil->id }}"
                                                            {{ old('kd_pilihan5') == $prog_pil->id ? 'selected' : '' }}>
                                                            {{ ucwords($prog_pil->program) }} - (Rp.
                                                            {{ number_format($prog_pil->harga) }})</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="kd_pilihan6" class="col-sm-12 col-form-label">Program Pilihan
                                                    6</label>
                                                <select name="kd_pilihan6" class="custom-select" id="kd_pilihan6"
                                                    onchange="hitungBiaya()">
                                                    <option value="0">Pilih Program</option>
                                                    @foreach ($program_pilihan as $prog_pil)
                                                        <option data-price="{{ $prog_pil->harga }}" required
                                                            value="{{ $prog_pil->id }}"
                                                            {{ old('kd_pilihan6') == $prog_pil->id ? 'selected' : '' }}>
                                                            {{ ucwords($prog_pil->program) }} - (Rp.
                                                            {{ number_format($prog_pil->harga) }})</option>
                                                    @endforeach
                                                </select>
                                ...
                                <div id="program-paket" style="display:none;">
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="kd_paket" class="col-sm-12 col-form-label">Program Paket <span
                                                        class="text-danger">*</span></label>
                                                <select id="kd_paket" name="kd_paket" class="custom-select">
                                                    <option value="0">Pilih Program</option>
                                                    @foreach ($program_paket as $prog_pak)
                                                        <option data-price="{{ $prog_pak->harga }}"
                                                            value="{{ $prog_pak->id }}"
                                                            {{ old('kd_paket') == $prog_pak->id ? 'selected' : '' }}>
                                                            Paket {{ ucwords($prog_pak->kode) }} - (Rp.
                                                            {{ number_format($prog_pak->harga) }})
                                                        </option>
                                                    @endforeach
                                                </select>
                                                @error('kd_paket')
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="kd_tambahan" class="col-sm-12 col-form-label">Program Tambahan
                                                    1</label>
                                                <select id="kd_tambahan" name="kd_tambahan" class="custom-select">
                                                    <option value="0">Pilih Program</option>
                                                    @foreach ($program_pilihan as $prog_pil)
                                                        <option data-price="{{ $prog_pil->harga }}"
                                                            value="{{ $prog_pil->id }}"
                                                            {{ old('kd_tambahan') == $prog_pil->id ? 'selected' : '' }}>
                                                            {{ ucwords($prog_pil->program) }} - (Rp.
                                                            {{ number_format($prog_pil->harga) }})
                                                        </option>
                                                    @endforeach
                                                </select>
                                                @error('kd_tambahan')
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="kd_tambahan2" class="col-sm-12 col-form-label">Program
                                                    Tambahan 2</label>
                                                <select id="kd_tambahan2" name="kd_tambahan2" class="custom-select">
                                                    ...
                                                    @foreach ($program_pilihan as $prog_pil)
                                                        <option data-price="{{ $prog_pil->harga }}"
                                                            value="{{ $prog_pil->id }}"
                                                            {{ old('kd_tambahan2') == $prog_pil->id ? 'selected' : '' }}>
                                                            {{ ucwords($prog_pil->program) }} - (Rp.
                                                            {{ number_format($prog_pil->harga) }})
                                                        </option>
                                                    @endforeach
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="kd_tambahan3" class="col-sm-12 col-form-label">Program
                                                    Tambahan 3</label>
                                                <select id="kd_tambahan3" name="kd_tambahan3" class="custom-select">
                                                    ...
                                                    @foreach ($program_pilihan as $prog_pil)
                                                        <option data-price="{{ $prog_pil->harga }}"
                                                            value="{{ $prog_pil->id }}"
                                                            {{ old('kd_tambahan3') == $prog_pil->id ? 'selected' : '' }}>
                                                            {{ ucwords($prog_pil->program) }} - (Rp.
                                                            {{ number_format($prog_pil->harga) }})
                                                        </option>
                                                    @endforeach
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="kd_tambahan4" class="col-sm-12 col-form-label">Program
                                                    Tambahan 4</label>
                                                <select id="kd_tambahan4" name="kd_tambahan4" class="custom-select">
                                                    ...
                                                    @foreach ($program_pilihan as $prog_pil)
                                                        <option data-price="{{ $prog_pil->harga }}"
                                                            value="{{ $prog_pil->id }}"
                                                            {{ old('kd_tambahan4') == $prog_pil->id ? 'selected' : '' }}>
                                                            {{ ucwords($prog_pil->program) }} - (Rp.
                                                            {{ number_format($prog_pil->harga) }})
                                                        </option>
                                                    @endforeach
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h4>
                                ...
                                <small
                                    class="float-right">{{ \Carbon\Carbon::parse($pendaftar->tgl_masuk)->translatedFormat('d F Y') }}</small>
                            </h4>
                        </div>
                        <!-- /.col -->
                    </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody id="angsuranTableBody">
                                    <tr>
                                        ...
                                        <td></td>
                                        <td colspan="2">
                                            <input readonly type="text" required name="biaya_kursus"
                                                class="form-control form-control-sm" id="biaya_kursus"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <input
                                                value="Rp. {{ number_format($biaya_daftar->biaya_daftar, 0, '', '.') }}"
                                                readonly required type="text" name="biaya_daftar"
                                                class="form-control form-control-sm @error('biaya_daftar') is-invalid @enderror"
                                                id="biaya_daftar" placeholder="Otomatis">
                                            @error('biaya_daftar')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td colspan="2">
                                            <input value="" required type="text" name="discount"
                                                class="form-control form-control-sm @error('discount') is-invalid @enderror"
                                                id="discount" placeholder="Isi Discount"
                                                onkeyup="formatRupiah(this); calculateKekurangan();">
                                            @error('discount')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td colspan="2">
                                            <input value="" readonly required type="text" name="tot_biaya"
                                                class="form-control form-control-sm @error('tot_biaya') is-invalid @enderror"
                                                id="tot_biaya" placeholder="Otomatis">
                                            @error('tot_biaya')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input value="{{ $pendaftar->tgl_masuk }}" readonly required type="date"
                                                name="tgl_angsuran1"
                                                class="form-control form-control-sm @error('tgl_angsuran1') is-invalid @enderror"
                                                id="tgl_angsuran1" placeholder="Tanggal Lahir">
                                            @error('tgl_angsuran1')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <td colspan="2">
                                            <input value="0" required type="text" name="angsuran1"
                                                class="form-control form-control-sm @error('angsuran1') is-invalid @enderror"
                                                id="angsuran1" placeholder="Pembayaran Awal"
                                                onkeyup="formatRupiah(this); calculateKekurangan();">
                                            @error('angsuran1')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                        ...
                        <div class="col-12">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tr>
                                        <th style="width:60%;">
                                            <h4 style="text-align: right">Kekurangan</h4>
                                        </th>
                                        <td style="width: 5%">
                                            <span id="kekuranganStatus" class="ml-2" style="display: none;">
                                                <span class="right badge badge-success">LUNAS </span> <i
                                                    class="fas fa-check-circle text-success"></i>
                                            </span>
                                        </td>
                                        <td style="width:35%">
                                            <input value="" readonly required type="text" name="kekurangan"
                                                class="form-control @error('kekurangan') is-invalid @enderror"
                                                id="kekurangan" placeholder="Otomatis" style="flex: 1;">
                                            @error('kekurangan')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
