                        ...
                        <div class="card-body">
                            ...
                            <form method="GET" action="{{ route('pendaftaran.index') }}">
                                <div class="input-group mb-3">
                                    <input type="text" name="search" autofocus autocomplete="off" class="form-control"
                                ...
                                <tbody>
                                    @foreach ($datas as $index => $data)
                                        <tr>
                                            ...
                                            <td>{{ 'Rp ' . number_format(($data->biaya_kursus ?? 0) + ($data->biaya_daftar ?? 0), 0, ',', '.') }}
                                            </td>
                                            <td>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Apakah yakin Peserta a.n.
                                                            <b>{{ ucwords($data->nm_lengkap) }}</b> dihapus? <b
                                                                style="color: red">Ingat,
                                                                keseluruhan
                                                                data dari peserta tersebut akan terhapus.</b>
                                                        </p>
                                                    </div>
                                                    <div class="modal-footer justify-content-between">
                                                        <form
                                                            action="{{ route('pendaftaran.destroy', ['pendaftaran' => $data->no_induk]) }}"
