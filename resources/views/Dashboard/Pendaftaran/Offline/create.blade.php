            ...
            <div class="row">
                <div class="col-12 col-sm-12">
                    <div class="card card-primary card-tabs">
                        ...
                        <form method="POST" action="/admin/pendaftaran" class="form-horizontal">
                            @csrf
                            <div class="card-body">
                                    ...
                                    <div class="tab-pane fade show active" id="custom-tabs-two-home" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $newNIS }}" readonly required type="text"
                                                        name="no_induk"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('nm_lengkap') }}" autofocus required type="text"
                                                        name="nm_lengkap"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="tmp_lahir" class="col-sm-12 col-form-label">Tempat Lahir
                                                        <span class="text-danger">*</span></label>
                                                    <input value="{{ old('tmp_lahir') }}" required type="text"
                                                        name="tmp_lahir"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="tgl_lahir" class="col-sm-12 col-form-label">Tanggal Lahir
                                                        <span class="text-danger">*</span></label>
                                                    <input value="{{ old('tgl_lahir') }}" required type="date"
                                                        name="tgl_lahir"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="gender" id="gender"
                                                        ...
                                                        <option value="l"
                                                            {{ old('gender') == 'l' ? 'selected' : '' }}>Laki-laki</option>
                                                        <option value="p"
                                                            {{ old('gender') == 'p' ? 'selected' : '' }}>Perempuan</option>
                                                    </select>
                                                    @error('gender')
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('nisn') }}" type="text" name="nisn"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="agama" id="agama"
                                                        ...
                                                        <option value="Lainnya"
                                                            {{ old('agama') == 'Lainnya' ? 'selected' : '' }}>Lainnya
                                                        </option>
                                                    </select>
                                                    @error('agama')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="kewarganegaraan" class="custom-select" required>
                                                        ...
                                                        <option value="wni"
                                                            {{ old('kewarganegaraan') == 'wni' ? 'selected' : '' }}>Warga
                                                            Negara Indonesia (WNI)</option>
                                                        <option value="wna"
                                                            {{ old('kewarganegaraan') == 'wna' ? 'selected' : '' }}>Warga
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="pend_akhir"
                                                        ...
                                                        <option value="tidak sekolah"
                                                            {{ old('pend_akhir') == 'tidak sekolah' ? 'selected' : '' }}>
                                                            Tidak Sekolah</option>
                                                        <option value="sd"
                                                            {{ old('pend_akhir') == 'sd' ? 'selected' : '' }}>SD</option>
                                                        <option value="smp"
                                                            {{ old('pend_akhir') == 'smp' ? 'selected' : '' }}>SMP</option>
                                                        <option value="SLTA"
                                                            {{ old('pend_akhir') == 'SLTA' ? 'selected' : '' }}>SLTA
                                                        </option>
                                                        <option value="d3"
                                                            {{ old('pend_akhir') == 'd3' ? 'selected' : '' }}>D3</option>
                                                        <option value="d4/s1"
                                                            {{ old('pend_akhir') == 'd4/s1' ? 'selected' : '' }}>D4/S1
                                                        </option>
                                                        <option value="s2"
                                                            {{ old('pend_akhir') == 's2' ? 'selected' : '' }}>S2</option>
                                                        <option value="s3"
                                                            {{ old('pend_akhir') == 's3' ? 'selected' : '' }}>S3</option>
                                                    </select>
                                                    @error('pend_akhir')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('email') }}" type="email" autocomplete="off"
                                                        name="email"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('no_hp') }}" type="text" name="no_hp"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="status_pekerjaan" id="status_pekerjaan"
                                                        ...
                                                        <option value="tidak bekerja"
                                                            {{ old('status_pekerjaan') == 'tidak bekerja' ? 'selected' : '' }}>
                                                            Tidak Bekerja</option>
                                                        <option value="nelayan"
                                                            {{ old('status_pekerjaan') == 'nelayan' ? 'selected' : '' }}>
                                                            Nelayan</option>
                                                        <option value="petani"
                                                            {{ old('status_pekerjaan') == 'petani' ? 'selected' : '' }}>
                                                            Petani</option>
                                                        <option value="peternak"
                                                            {{ old('status_pekerjaan') == 'peternak' ? 'selected' : '' }}>
                                                            Peternak</option>
                                                        <option value="pns/tni/polri"
                                                            {{ old('status_pekerjaan') == 'pns/tni/polri' ? 'selected' : '' }}>
                                                            PNS/TNI/Polri</option>
                                                        <option value="guru"
                                                            {{ old('status_pekerjaan') == 'guru' ? 'selected' : '' }}>Guru
                                                        </option>
                                                        <option value="karyawan swasta"
                                                            {{ old('status_pekerjaan') == 'karyawan swasta' ? 'selected' : '' }}>
                                                            Karyawan Swasta</option>
                                                        <option value="pedagang/wiraswasta"
                                                            {{ old('status_pekerjaan') == 'pedagang/wiraswasta' ? 'selected' : '' }}>
                                                            Pedagang/Wiraswasta</option>
                                                        <option value="buruh"
                                                            {{ old('status_pekerjaan') == 'buruh' ? 'selected' : '' }}>
                                                            Buruh</option>
                                                        <option value="pensiunan"
                                                            {{ old('status_pekerjaan') == 'pensiunan' ? 'selected' : '' }}>
                                                            Pensiunan</option>
                                                        <option value="lainnya"
                                                            {{ old('status_pekerjaan') == 'lainnya' ? 'selected' : '' }}>
                                                            Lainnya</option>
                                                    </select>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="tgl_masuk" class="col-sm-12 col-form-label">Tanggal Daftar
                                                        <span class="text-danger">*</span></label>
                                                    <input value="{{ old('tgl_masuk') }}" required type="date"
                                                        name="tgl_masuk"
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="{{ route('pendaftaran.index') }}"><button type="button"
                                                    class="btn btn-light float-left" id="nextalamat">Back</button></a>
                                        </div>
                                        <!-- /.card-footer -->
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="alamat" class="col-sm-12 col-form-label">Alamat Lengkap
                                                        <span class="text-danger">*</span></label>
                                                    <input value="{{ old('alamat') }}" autofocus required type="text"
                                                        name="alamat"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('rt') }}" type="text" name="rt"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('rw') }}" type="text" name="rw"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="kel" class="col-sm-12 col-form-label">Desa /
                                                        Kelurahan</label>
                                                    <input value="{{ old('kel') }}" type="text" name="kel"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('kec') }}" type="text" name="kec"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('kd_pos') }}" type="text" name="kd_pos"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('kab') }}" required type="text"
                                                        name="kab"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="provinsi" id="provinsi"
                                                        ...
                                                        <option value="Aceh"
                                                            {{ old('provinsi') == 'Aceh' ? 'selected' : '' }}>Aceh</option>
                                                        <option value="Sumatera Utara"
                                                            {{ old('provinsi') == 'Sumatera Utara' ? 'selected' : '' }}>
                                                            Sumatera Utara</option>
                                                        <option value="Sumatera Barat"
                                                            {{ old('provinsi') == 'Sumatera Barat' ? 'selected' : '' }}>
                                                            Sumatera Barat</option>
                                                        <option value="Riau"
                                                            {{ old('provinsi') == 'Riau' ? 'selected' : '' }}>Riau</option>
                                                        <option value="Jambi"
                                                            {{ old('provinsi') == 'Jambi' ? 'selected' : '' }}>Jambi
                                                        </option>
                                                        <option value="Sumatera Selatan"
                                                            {{ old('provinsi') == 'Sumatera Selatan' ? 'selected' : '' }}>
                                                            Sumatera Selatan</option>
                                                        <option value="Bengkulu"
                                                            {{ old('provinsi') == 'Bengkulu' ? 'selected' : '' }}>Bengkulu
                                                        </option>
                                                        <option value="Lampung"
                                                            {{ old('provinsi') == 'Lampung' ? 'selected' : '' }}>Lampung
                                                        </option>
                                                        <option value="Kepulauan Bangka Belitung"
                                                            {{ old('provinsi') == 'Kepulauan Bangka Belitung' ? 'selected' : '' }}>
                                                            Kepulauan Bangka Belitung</option>
                                                        <option value="Kepulauan Riau"
                                                            {{ old('provinsi') == 'Kepulauan Riau' ? 'selected' : '' }}>
                                                            Kepulauan Riau</option>
                                                        <option value="DKI Jakarta"
                                                            {{ old('provinsi') == 'DKI Jakarta' ? 'selected' : '' }}>DKI
                                                            Jakarta</option>
                                                        <option value="Jawa Barat"
                                                            {{ old('provinsi') == 'Jawa Barat' ? 'selected' : '' }}>Jawa
                                                            Barat</option>
                                                        <option value="Jawa Tengah"
                                                            {{ old('provinsi') == 'Jawa Tengah' ? 'selected' : '' }}>Jawa
                                                            Tengah</option>
                                                        <option value="DI Yogyakarta"
                                                            {{ old('provinsi') == 'DI Yogyakarta' ? 'selected' : '' }}>DI
                                                            Yogyakarta</option>
                                                        <option value="Jawa Timur"
                                                            {{ old('provinsi') == 'Jawa Timur' ? 'selected' : '' }}>Jawa
                                                            Timur</option>
                                                        <option value="Banten"
                                                            {{ old('provinsi') == 'Banten' ? 'selected' : '' }}>Banten
                                                        </option>
                                                        <option value="Bali"
                                                            {{ old('provinsi') == 'Bali' ? 'selected' : '' }}>Bali</option>
                                                        <option value="Nusa Tenggara Barat"
                                                            {{ old('provinsi') == 'Nusa Tenggara Barat' ? 'selected' : '' }}>
                                                            Nusa Tenggara Barat</option>
                                                        <option value="Nusa Tenggara Timur"
                                                            {{ old('provinsi') == 'Nusa Tenggara Timur' ? 'selected' : '' }}>
                                                            Nusa Tenggara Timur</option>
                                                        <option value="Kalimantan Barat"
                                                            {{ old('provinsi') == 'Kalimantan Barat' ? 'selected' : '' }}>
                                                            Kalimantan Barat</option>
                                                        <option value="Kalimantan Tengah"
                                                            {{ old('provinsi') == 'Kalimantan Tengah' ? 'selected' : '' }}>
                                                            Kalimantan Tengah</option>
                                                        <option value="Kalimantan Selatan"
                                                            {{ old('provinsi') == 'Kalimantan Selatan' ? 'selected' : '' }}>
                                                            Kalimantan Selatan</option>
                                                        <option value="Kalimantan Timur"
                                                            {{ old('provinsi') == 'Kalimantan Timur' ? 'selected' : '' }}>
                                                            Kalimantan Timur</option>
                                                        <option value="Kalimantan Utara"
                                                            {{ old('provinsi') == 'Kalimantan Utara' ? 'selected' : '' }}>
                                                        ...
                                                        <option value="Sulawesi Tengah"
                                                            {{ old('provinsi') == 'Sulawesi Tengah' ? 'selected' : '' }}>
                                                        ...
                                                        <option value="Sulawesi Tenggara"
                                                            {{ old('provinsi') == 'Sulawesi Tenggara' ? 'selected' : '' }}>
                                                            Sulawesi Tenggara</option>
                                                        <option value="Gorontalo"
                                                            {{ old('provinsi') == 'Gorontalo' ? 'selected' : '' }}>
                                                            Gorontalo</option>
                                                        <option value="Sulawesi Barat"
                                                            {{ old('provinsi') == 'Sulawesi Barat' ? 'selected' : '' }}>
                                                            Sulawesi Barat</option>
                                                        <option value="Maluku"
                                                            {{ old('provinsi') == 'Maluku' ? 'selected' : '' }}>Maluku
                                                        </option>
                                                        <option value="Maluku Utara"
                                                            {{ old('provinsi') == 'Maluku Utara' ? 'selected' : '' }}>
                                                            Maluku Utara</option>
                                                        <option value="Papua Barat"
                                                            {{ old('provinsi') == 'Papua Barat' ? 'selected' : '' }}>Papua
                                                            Barat</option>
                                                        <option value="Papua"
                                                            {{ old('provinsi') == 'Papua' ? 'selected' : '' }}>Papua
                                                        </option>
                                                        <option value="Papua Tengah"
                                                            {{ old('provinsi') == 'Papua Tengah' ? 'selected' : '' }}>
                                                            Papua Tengah</option>
                                                        <option value="Papua Pegunungan"
                                                            {{ old('provinsi') == 'Papua Pegunungan' ? 'selected' : '' }}>
                                                            Papua Pegunungan</option>
                                                        <option value="Papua Selatan"
                                                            {{ old('provinsi') == 'Papua Selatan' ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="jns_tinggal" id="jns_tinggal"
                                                        ...
                                                        <option value="rumah_sendiri"
                                                            {{ old('jns_tinggal') == 'rumah_sendiri' ? 'selected' : '' }}>
                                                            Rumah Sendiri</option>
                                                        <option value="kos"
                                                            {{ old('jns_tinggal') == 'kos' ? 'selected' : '' }}>Kos
                                                        </option>
                                                        <option value="kontrak"
                                                            {{ old('jns_tinggal') == 'kontrak' ? 'selected' : '' }}>
                                                            Kontrak</option>
                                                        <option value="bersama_orang_tua"
                                                            {{ old('jns_tinggal') == 'bersama_orang_tua' ? 'selected' : '' }}>
                                                            Bersama Orang Tua</option>
                                                        <option value="bersama_wali"
                                                            {{ old('jns_tinggal') == 'bersama_wali' ? 'selected' : '' }}>
                                                            Bersama Wali</option>
                                                        <option value="lainnya"
                                                            {{ old('jns_tinggal') == 'lainnya' ? 'selected' : '' }}>
                                                            Lainnya</option>
                                                    </select>
                                                    @error('jns_tinggal')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="nm_ayah" class="col-sm-12 col-form-label">Nama
                                                        Ayah</label>
                                                    <input value="{{ old('nm_ayah') }}" type="text" name="nm_ayah"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="nik_ayah" class="col-sm-12 col-form-label">NIK
                                                        Ayah</label>
                                                    <input value="{{ old('nik_ayah') }}" type="text" name="nik_ayah"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="tgl_ayah" class="col-sm-12 col-form-label">Tanggal Lahir
                                                        Ayah</label>
                                                    <input value="{{ old('tgl_ayah') }}" type="date" name="tgl_ayah"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="pend_ayah"
                                                        ...
                                                        <option value="" {{ old('pend_ayah') ? '' : 'selected' }}>
                                                            Pilih Pendidikan Terakhir</option>
                                                        <option value="tidak sekolah"
                                                            {{ old('pend_ayah') == 'tidak sekolah' ? 'selected' : '' }}>
                                                            Tidak Sekolah</option>
                                                        <option value="sd"
                                                            {{ old('pend_ayah') == 'sd' ? 'selected' : '' }}>SD</option>
                                                        <option value="smp"
                                                            {{ old('pend_ayah') == 'smp' ? 'selected' : '' }}>SMP</option>
                                                        <option value="SLTA"
                                                            {{ old('pend_ayah') == 'SLTA' ? 'selected' : '' }}>SLTA
                                                        </option>
                                                        <option value="d3"
                                                            {{ old('pend_ayah') == 'd3' ? 'selected' : '' }}>D3</option>
                                                        <option value="d4/s1"
                                                            {{ old('pend_ayah') == 'd4/s1' ? 'selected' : '' }}>D4/S1
                                                        </option>
                                                        <option value="s2"
                                                            {{ old('pend_ayah') == 's2' ? 'selected' : '' }}>S2</option>
                                                        <option value="s3"
                                                            {{ old('pend_ayah') == 's3' ? 'selected' : '' }}>S3</option>
                                                    </select>
                                                    @error('pend_ayah')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="pek_ayah" id="pek_ayah"
                                                        ...
                                                        <option value="tidak bekerja"
                                                            {{ old('pek_ayah') == 'tidak bekerja' ? 'selected' : '' }}>
                                                            Tidak Bekerja</option>
                                                        <option value="nelayan"
                                                            {{ old('pek_ayah') == 'nelayan' ? 'selected' : '' }}>Nelayan
                                                        </option>
                                                        <option value="petani"
                                                            {{ old('pek_ayah') == 'petani' ? 'selected' : '' }}>Petani
                                                        </option>
                                                        <option value="peternak"
                                                            {{ old('pek_ayah') == 'peternak' ? 'selected' : '' }}>Peternak
                                                        </option>
                                                        <option value="pns/tni/polri"
                                                            {{ old('pek_ayah') == 'pns/tni/polri' ? 'selected' : '' }}>
                                                            PNS/TNI/Polri</option>
                                                        <option value="guru"
                                                            {{ old('pek_ayah') == 'guru' ? 'selected' : '' }}>Guru
                                                        </option>
                                                        <option value="karyawan swasta"
                                                            {{ old('pek_ayah') == 'karyawan swasta' ? 'selected' : '' }}>
                                                            Karyawan Swasta</option>
                                                        <option value="pedagang/wiraswasta"
                                                            {{ old('pek_ayah') == 'pedagang/wiraswasta' ? 'selected' : '' }}>
                                                            Pedagang/Wiraswasta</option>
                                                        <option value="buruh"
                                                            {{ old('pek_ayah') == 'buruh' ? 'selected' : '' }}>Buruh
                                                        </option>
                                                        <option value="pensiunan"
                                                            {{ old('pek_ayah') == 'pensiunan' ? 'selected' : '' }}>
                                                            Pensiunan</option>
                                                        <option value="lainnya"
                                                            {{ old('pek_ayah') == 'lainnya' ? 'selected' : '' }}>Lainnya
                                                        </option>
                                                    </select>
                                                    @error('pek_ayah')
                                                        <div class="invalid-feedback">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="nm_ibu" class="col-sm-12 col-form-label">Nama
                                                        Ibu</label>
                                                    <input value="{{ old('nm_ibu') }}" autofocus type="text"
                                                        name="nm_ibu"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('nik_ibu') }}" type="text" name="nik_ibu"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="tgl_ibu" class="col-sm-12 col-form-label">Tanggal Lahir
                                                        Ibu</label>
                                                    <input value="{{ old('tgl_ibu') }}" type="date" name="tgl_ibu"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="pend_ibu"
                                                        ...
                                                        <option value="" {{ old('pend_ibu') ? '' : 'selected' }}>
                                                            Pilih Pendidikan Terakhir</option>
                                                        <option value="tidak sekolah"
                                                            {{ old('pend_ibu') == 'tidak sekolah' ? 'selected' : '' }}>
                                                            Tidak Sekolah</option>
                                                        <option value="sd"
                                                            {{ old('pend_ibu') == 'sd' ? 'selected' : '' }}>SD</option>
                                                        <option value="smp"
                                                            {{ old('pend_ibu') == 'smp' ? 'selected' : '' }}>SMP</option>
                                                        <option value="SLTA"
                                                            {{ old('pend_ibu') == 'SLTA' ? 'selected' : '' }}>SLTA
                                                        </option>
                                                        <option value="d3"
                                                            {{ old('pend_ibu') == 'd3' ? 'selected' : '' }}>D3</option>
                                                        <option value="d4/s1"
                                                            {{ old('pend_ibu') == 'd4/s1' ? 'selected' : '' }}>D4/S1
                                                        </option>
                                                        <option value="s2"
                                                            {{ old('pend_ibu') == 's2' ? 'selected' : '' }}>S2</option>
                                                        <option value="s3"
                                                            {{ old('pend_ibu') == 's3' ? 'selected' : '' }}>S3</option>
                                                    </select>
                                                    @error('pend_ibu')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="pek_ibu" id="pek_ibu"
                                                        ...
                                                        <option value="" {{ old('pek_ibu') ? '' : 'selected' }}>
                                                            Pilih Pekerjaan</option>
                                                        <option value="tidak bekerja"
                                                            {{ old('pek_ibu') == 'tidak bekerja' ? 'selected' : '' }}>
                                                            Tidak Bekerja</option>
                                                        <option value="nelayan"
                                                            {{ old('pek_ibu') == 'nelayan' ? 'selected' : '' }}>Nelayan
                                                        </option>
                                                        <option value="petani"
                                                            {{ old('pek_ibu') == 'petani' ? 'selected' : '' }}>Petani
                                                        </option>
                                                        <option value="peternak"
                                                            {{ old('pek_ibu') == 'peternak' ? 'selected' : '' }}>Peternak
                                                        </option>
                                                        <option value="pns/tni/polri"
                                                            {{ old('pek_ibu') == 'pns/tni/polri' ? 'selected' : '' }}>
                                                            PNS/TNI/Polri</option>
                                                        <option value="guru"
                                                            {{ old('pek_ibu') == 'guru' ? 'selected' : '' }}>Guru</option>
                                                        <option value="karyawan swasta"
                                                            {{ old('pek_ibu') == 'karyawan swasta' ? 'selected' : '' }}>
                                                            Karyawan Swasta</option>
                                                        <option value="pedagang/wiraswasta"
                                                            {{ old('pek_ibu') == 'pedagang/wiraswasta' ? 'selected' : '' }}>
                                                            Pedagang/Wiraswasta</option>
                                                        <option value="buruh"
                                                            {{ old('pek_ibu') == 'buruh' ? 'selected' : '' }}>Buruh
                                                        </option>
                                                        <option value="pensiunan"
                                                            {{ old('pek_ibu') == 'pensiunan' ? 'selected' : '' }}>
                                                            Pensiunan</option>
                                                        <option value="lainnya"
                                                            {{ old('pek_ibu') == 'lainnya' ? 'selected' : '' }}>Lainnya
                                                        </option>
                                                    </select>
                                                    @error('pek_ibu')
                                                        <div class="invalid-feedback">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="alamat_ortu" class="col-sm-12 col-form-label">Alamat Orang
                                                        Tua</label>
                                                    <input value="{{ old('alamat_ortu') }}" autofocus type="text"
                                                        name="alamat_ortu"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="hp_ortu" class="col-sm-12 col-form-label">HP Orang
                                                        Tua</label>
                                                    <input value="{{ old('hp_ortu') }}" autofocus type="text"
                                                        name="hp_ortu"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="telepon_ortu" class="col-sm-12 col-form-label">Telepon
                                                        Orang Tua</label>
                                                    <input value="{{ old('telepon_ortu') }}" autofocus type="text"
                                                        name="telepon_ortu"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('anak_ke') }}" autofocus type="text"
                                                        name="anak_ke"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="nm_wali" class="col-sm-12 col-form-label">Nama
                                                        Wali</label>
                                                    <input value="{{ old('nm_wali') }}" type="text" name="nm_wali"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="nik_wali" class="col-sm-12 col-form-label">NIK
                                                        Wali</label>
                                                    <input value="{{ old('nik_wali') }}" type="text" name="nik_wali"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="tgl_wali" class="col-sm-12 col-form-label">Tanggal Lahir
                                                        Wali</label>
                                                    <input value="{{ old('tgl_wali') }}" type="date" name="tgl_wali"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="pend_wali"
                                                        ...
                                                        <option value="" {{ old('pend_wali') ? '' : 'selected' }}>
                                                            Pilih Pendidikan Terakhir</option>
                                                        <option value="tidak sekolah"
                                                            {{ old('pend_wali') == 'tidak sekolah' ? 'selected' : '' }}>
                                                            Tidak Sekolah</option>
                                                        <option value="sd"
                                                            {{ old('pend_wali') == 'sd' ? 'selected' : '' }}>SD</option>
                                                        <option value="smp"
                                                            {{ old('pend_wali') == 'smp' ? 'selected' : '' }}>SMP</option>
                                                        <option value="SLTA"
                                                            {{ old('pend_wali') == 'SLTA' ? 'selected' : '' }}>SLTA
                                                        </option>
                                                        <option value="d3"
                                                            {{ old('pend_wali') == 'd3' ? 'selected' : '' }}>D3</option>
                                                        <option value="d4/s1"
                                                            {{ old('pend_wali') == 'd4/s1' ? 'selected' : '' }}>D4/S1
                                                        </option>
                                                        <option value="s2"
                                                            {{ old('pend_wali') == 's2' ? 'selected' : '' }}>S2</option>
                                                        <option value="s3"
                                                            {{ old('pend_wali') == 's3' ? 'selected' : '' }}>S3</option>
                                                    </select>
                                                    @error('pend_wali')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="pek_wali" id="pek_wali"
                                                        ...
                                                        <option value="" {{ old('pek_wali') ? '' : 'selected' }}>
                                                            Pilih Pekerjaan</option>
                                                        <option value="tidak bekerja"
                                                            {{ old('pek_wali') == 'tidak bekerja' ? 'selected' : '' }}>
                                                            Tidak Bekerja</option>
                                                        <option value="nelayan"
                                                            {{ old('pek_wali') == 'nelayan' ? 'selected' : '' }}>Nelayan
                                                        </option>
                                                        <option value="petani"
                                                            {{ old('pek_wali') == 'petani' ? 'selected' : '' }}>Petani
                                                        </option>
                                                        <option value="peternak"
                                                            {{ old('pek_wali') == 'peternak' ? 'selected' : '' }}>Peternak
                                                        </option>
                                                        <option value="pns/tni/polri"
                                                            {{ old('pek_wali') == 'pns/tni/polri' ? 'selected' : '' }}>
                                                            PNS/TNI/Polri</option>
                                                        <option value="guru"
                                                            {{ old('pek_wali') == 'guru' ? 'selected' : '' }}>Guru
                                                        </option>
                                                        <option value="karyawan swasta"
                                                            {{ old('pek_wali') == 'karyawan swasta' ? 'selected' : '' }}>
                                                            Karyawan Swasta</option>
                                                        <option value="pedagang/wiraswasta"
                                                            {{ old('pek_wali') == 'pedagang/wiraswasta' ? 'selected' : '' }}>
                                                            Pedagang/Wiraswasta</option>
                                                        <option value="buruh"
                                                            {{ old('pek_wali') == 'buruh' ? 'selected' : '' }}>Buruh
                                                        </option>
                                                        <option value="pensiunan"
                                                            {{ old('pek_wali') == 'pensiunan' ? 'selected' : '' }}>
                                                            Pensiunan</option>
                                                        <option value="lainnya"
                                                            {{ old('pek_wali') == 'lainnya' ? 'selected' : '' }}>Lainnya
                                                        </option>
                                                    </select>
                                                    @error('pek_wali')
                                                        <div class="invalid-feedback">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('hp_wali') }}" type="text" name="hp_wali"
