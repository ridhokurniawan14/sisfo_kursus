        ...
        <div class="row">
          <div class="col-12 col-sm-12">
            <div class="card card-primary card-tabs">
              ...
              <form method="POST" action="/pendaftaran" class="form-horizontal">
                @csrf
              <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input value="{{ old('nm_lengkap') }}" autofocus required type="text" name="nm_lengkap" class="form-control @error('nm_lengkap') is-invalid @enderror" id="nm_lengkap" placeholder="Nama Lengkap">
                          @error('nm_lengkap')
                            <div class="invalid-feedback">
                              {{ $message }}
                            </div>
                        ...
                        <div class="form-group"> 
                          <label for="pend_akhir" class="col-sm-12 col-form-label">Pendidikan Terakhir <span class="text-danger">*</span></label>
                            <select name="pend_akhir" class="form-control @error('pend_akhir') is-invalid @enderror" required>
                                ...
                                <option value="SLTA" {{ old('pend_akhir') == 'SLTA' ? 'selected' : '' }}>SLTA</option>
                                <option value="d3" {{ old('pend_akhir') == 'd3' ? 'selected' : '' }}>D3</option>
                                <option value="d4/s1" {{ old('pend_akhir') == 'd4/s1' ? 'selected' : '' }}>D4/S1</option>
                      ...
                      <div class="col-sm-3"> 
                        <div class="form-group">
                          <label for="no_hp" class="col-sm-12 col-form-label">No. HP</label>
                            <input value="{{ old('no_hp') }}" type="text" name="no_hp" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp" placeholder="Nomor HP Aktif">
                            @error('no_hp')
                              <div class="invalid-feedback">
                                {{ $message }}
                              </div>
                      ...
                      <div class="col-sm-3"> 
                        <div class="form-group">
                          ...
                          <select name="status_pekerjaan" id="status_pekerjaan" class="form-control @error('status_pekerjaan') is-invalid @enderror" required>
                              ...
                              <option value="peternak" {{ old('status_pekerjaan') == 'peternak' ? 'selected' : '' }}>Peternak</option>
                              <option value="pns/tni/polri" {{ old('status_pekerjaan') == 'pns/tni/polri' ? 'selected' : '' }}>PNS/TNI/Polri</option>
                              <option value="guru" {{ old('status_pekerjaan') == 'guru' ? 'selected' : '' }}>Guru</option>
                              <option value="karyawan swasta" {{ old('status_pekerjaan') == 'karyawan swasta' ? 'selected' : '' }}>Karyawan Swasta</option>
                              <option value="pedagang/wiraswasta" {{ old('status_pekerjaan') == 'pedagang/wiraswasta' ? 'selected' : '' }}>Pedagang/Wiraswasta</option>
                              <option value="buruh" {{ old('status_pekerjaan') == 'buruh' ? 'selected' : '' }}>Buruh</option>
                              <option value="pensiunan" {{ old('status_pekerjaan') == 'pensiunan' ? 'selected' : '' }}>Pensiunan</option>
                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input value="{{ old('alamat') }}" autofocus required type="text" name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="alamat" placeholder="Alamat Lengkap">
                          @error('alamat')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input value="{{ old('kab') }}" required type="text" name="kab" class="form-control @error('kab') is-invalid @enderror" id="kab" placeholder="Kabupaten/Kota">
                          @error('kab')
                            <div class="invalid-feedback">
                              {{ $message }}
                            </div>
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <select name="jns_tinggal" id="jns_tinggal" class="form-control @error('jns_tinggal') is-invalid @enderror" required>
                                ...
                                <option value="bersama_orang_tua" {{ old('jns_tinggal') == 'bersama_orang_tua' ? 'selected' : '' }}>Bersama Orang Tua</option>
                                <option value="bersama_wali" {{ old('jns_tinggal') == 'bersama_wali' ? 'selected' : '' }}>Bersama Wali</option>
                                <option value="lainnya" {{ old('jns_tinggal') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                            @error('jns_tinggal')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input value="{{ old('nm_ayah') }}" type="text" name="nm_ayah" class="form-control @error('nm_ayah') is-invalid @enderror" id="nm_ayah" placeholder="Nama Ayah">
                          @error('nm_ayah')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                        ...
                        <div class="form-group"> 
                          <label for="pend_ayah" class="col-sm-12 col-form-label">Pendidikan Ayah</label>
                            <select name="pend_ayah" class="form-control @error('pend_ayah') is-invalid @enderror">
                                ...
                                <option value="SLTA" {{ old('pend_ayah') == 'SLTA' ? 'selected' : '' }}>SLTA</option>
                                <option value="d3" {{ old('pend_ayah') == 'd3' ? 'selected' : '' }}>D3</option>
                                <option value="d4/s1" {{ old('pend_ayah') == 'd4/s1' ? 'selected' : '' }}>D4/S1</option>
                                <option value="s2" {{ old('pend_ayah') == 's2' ? 'selected' : '' }}>S2</option>
                                <option value="s3" {{ old('pend_ayah') == 's3' ? 'selected' : '' }}>S3</option>
                            </select>
                            @error('pend_ayah')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror             
                    ...
                    <div class="row">
                      <div class="col-sm-3"> 
                        <div class="form-group">
                          ...
                          <select name="pek_ayah" id="pek_ayah" class="form-control @error('pek_ayah') is-invalid @enderror">
                              ...
                              <option value="peternak" {{ old('pek_ayah') == 'peternak' ? 'selected' : '' }}>Peternak</option>
                              <option value="pns/tni/polri" {{ old('pek_ayah') == 'pns/tni/polri' ? 'selected' : '' }}>PNS/TNI/Polri</option>
                              <option value="guru" {{ old('pek_ayah') == 'guru' ? 'selected' : '' }}>Guru</option>
                              <option value="karyawan swasta" {{ old('pek_ayah') == 'karyawan swasta' ? 'selected' : '' }}>Karyawan Swasta</option>
                              <option value="pedagang/wiraswasta" {{ old('pek_ayah') == 'pedagang/wiraswasta' ? 'selected' : '' }}>Pedagang/Wiraswasta</option>
                              <option value="buruh" {{ old('pek_ayah') == 'buruh' ? 'selected' : '' }}>Buruh</option>
                              <option value="pensiunan" {{ old('pek_ayah') == 'pensiunan' ? 'selected' : '' }}>Pensiunan</option>
                              <option value="lainnya" {{ old('pek_ayah') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                          </select>
                          @error('pek_ayah')
                              <div class="invalid-feedback">
                                  {{ $message }}
                        ...
                        <div class="form-group"> 
                          <label for="pend_ibu" class="col-sm-12 col-form-label">Pendidikan Ibu</label>
                            <select name="pend_ibu" class="form-control @error('pend_ibu') is-invalid @enderror">
                                ...
                                <option value="SLTA" {{ old('pend_ibu') == 'SLTA' ? 'selected' : '' }}>SLTA</option>
                      ...
                      <div class="col-sm-3"> 
                        <div class="form-group">
                          ...
                          <select name="pek_ibu" id="pek_ibu" class="form-control @error('pek_ibu') is-invalid @enderror">
                              ...
                              <option value="peternak" {{ old('pek_ibu') == 'peternak' ? 'selected' : '' }}>Peternak</option>
                              <option value="pns/tni/polri" {{ old('pek_ibu') == 'pns/tni/polri' ? 'selected' : '' }}>PNS/TNI/Polri</option>
                              <option value="guru" {{ old('pek_ibu') == 'guru' ? 'selected' : '' }}>Guru</option>
                              <option value="karyawan swasta" {{ old('pek_ibu') == 'karyawan swasta' ? 'selected' : '' }}>Karyawan Swasta</option>
                              <option value="pedagang/wiraswasta" {{ old('pek_ibu') == 'pedagang/wiraswasta' ? 'selected' : '' }}>Pedagang/Wiraswasta</option>
                              <option value="buruh" {{ old('pek_ibu') == 'buruh' ? 'selected' : '' }}>Buruh</option>
                              <option value="pensiunan" {{ old('pek_ibu') == 'pensiunan' ? 'selected' : '' }}>Pensiunan</option>
                              <option value="lainnya" {{ old('pek_ibu') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                          </select>
                          @error('pek_ibu')
                              <div class="invalid-feedback">
                                  {{ $message }}
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input value="{{ old('alamat_ortu') }}" autofocus type="text" name="alamat_ortu" class="form-control @error('alamat_ortu') is-invalid @enderror" id="alamat_ortu" placeholder="Alamat Lengkap" >
                          @error('alamat_ortu')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                        ...
                        <div class="form-group"> 
                          <label for="pend_wali" class="col-sm-12 col-form-label">Pendidikan Wali</label>
                            <select name="pend_wali" class="form-control @error('pend_wali') is-invalid @enderror" required>
                                ...
                                <option value="SLTA" {{ old('pend_wali') == 'SLTA' ? 'selected' : '' }}>SLTA</option>
                                <option value="d3" {{ old('pend_wali') == 'd3' ? 'selected' : '' }}>D3</option>
                                <option value="d4/s1" {{ old('pend_wali') == 'd4/s1' ? 'selected' : '' }}>D4/S1</option>
                                <option value="s2" {{ old('pend_wali') == 's2' ? 'selected' : '' }}>S2</option>
                                <option value="s3" {{ old('pend_wali') == 's3' ? 'selected' : '' }}>S3</option>
                            </select>
                            @error('pend_wali')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror             
                      ...
                      <div class="col-sm-3"> 
                        <div class="form-group">
                          ...
                          <select name="pek_wali" id="pek_wali" class="form-control @error('pek_wali') is-invalid @enderror">
                              ...
                              <option value="peternak" {{ old('pek_wali') == 'peternak' ? 'selected' : '' }}>Peternak</option>
                              <option value="pns/tni/polri" {{ old('pek_wali') == 'pns/tni/polri' ? 'selected' : '' }}>PNS/TNI/Polri</option>
                              <option value="guru" {{ old('pek_wali') == 'guru' ? 'selected' : '' }}>Guru</option>
                              <option value="karyawan swasta" {{ old('pek_wali') == 'karyawan swasta' ? 'selected' : '' }}>Karyawan Swasta</option>
                              <option value="pedagang/wiraswasta" {{ old('pek_wali') == 'pedagang/wiraswasta' ? 'selected' : '' }}>Pedagang/Wiraswasta</option>
                              <option value="buruh" {{ old('pek_wali') == 'buruh' ? 'selected' : '' }}>Buruh</option>
                              <option value="pensiunan" {{ old('pek_wali') == 'pensiunan' ? 'selected' : '' }}>Pensiunan</option>
                              <option value="lainnya" {{ old('pek_wali') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                          </select>
                          @error('pek_wali')
                              <div class="invalid-feedback">
                                  {{ $message }}
