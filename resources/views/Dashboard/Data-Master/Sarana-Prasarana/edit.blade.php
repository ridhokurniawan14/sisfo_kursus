            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-warning">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="/admin/sarana-prasarana/{{ $cari->id }}" class="form-horizontal"
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select autofocus name="jenis" id="jenis"
                                                ...
                                                <option value="sarana"
                                                    {{ old('jenis', $cari->jenis) == 'sarana' ? 'selected' : '' }}>Sarana
                                                </option>
                                                <option value="prasarana"
                                                    {{ old('jenis', $cari->jenis) == 'prasarana' ? 'selected' : '' }}>
                                                    Prasarana</option>
                                            </select>
                                            @error('jenis')
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status"
                                                ...
                                                <option value="milik"
                                                    {{ old('status', $cari->status) == 'milik' ? 'selected' : '' }}>Milik
                                                </option>
                                                <option value="sewa"
                                                    {{ old('status', $cari->status) == 'sewa' ? 'selected' : '' }}>Sewa
                                                </option>
                                                <option value="pinjam"
                                                    {{ old('status', $cari->status) == 'pinjam' ? 'selected' : '' }}>
                                                    Pinjam</option>
                                                <option value="bukan milik"
                                                    {{ old('status', $cari->status) == 'bukan milik' ? 'selected' : '' }}>
                                                    Bukan Milik</option>
                                            </select>
                                            @error('status')
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('nm_sarpras', ucwords($cari->nm_sarpras)) }}" required
                                                type="text" name="nm_sarpras"
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label for="banyak" class="col-sm-12 col-form-label">Banyak <span
                                                    class="text-danger">*</span></label>
                                            <input value="{{ old('banyak', $cari->banyak) }}" required type="number"
                                                name="banyak" class="form-control @error('banyak') is-invalid @enderror"
                                                id="banyak" placeholder="Qty Barang">
                                            @error('banyak')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="ket" id="ket"
                                                ...
                                                <option value="layak digunakan"
                                                    {{ old('ket', $cari->ket) == 'layak digunakan' ? 'selected' : '' }}>
                                                    Layak Digunakan</option>
                                                <option value="tidak layak digunakan"
                                                    {{ old('ket', $cari->ket) == 'tidak layak digunakan' ? 'selected' : '' }}>
                                                    Tidak Layak Digunakan</option>
                                            </select>
                                            @error('ket')
