                            ...
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select autofocus name="jenis" id="jenis"
                                                ...
                                                <option value="pemberitahuan"
                                                    {{ old('jenis') == 'pemberitahuan' ? 'selected' : '' }}>Pemberitahuan
                                                </option>
                                                <option value="libur kursus"
                                                    {{ old('jenis') == 'libur kursus' ? 'selected' : '' }}>Libur Kursus
                                                </option>
                                                <option value="lowongan pekerjaan"
                                                    {{ old('jenis') == 'lowongan pekerjaan' ? 'selected' : '' }}>Lowongan
                                                    Pekerjaan</option>
                                                <option value="lomba" {{ old('jenis') == 'lomba' ? 'selected' : '' }}>Lomba
                                                </option>
                                            </select>
                                            @error('jenis')
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            <label for="judul">Judul Pengumuman<span class="text-danger">
                                                    *</span></label>
                                            <input autocomplete="off" value="{{ old('judul') }}" required type="text"
                                                name="judul" class="form-control @error('judul') is-invalid @enderror"
                                                id="judul" placeholder="Misal : Libur Hari Raya">
                                            @error('judul')
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select name="untuk" id="untuk"
                                                ...
                                                <option value="semua" {{ old('untuk') == 'semua' ? 'selected' : '' }}>Semua
                                                </option>
                                                <option value="peserta didik"
                                                    {{ old('untuk') == 'peserta didik' ? 'selected' : '' }}>Peserta Didik
                                                </option>
                                                <option value="pendidik" {{ old('untuk') == 'pendidik' ? 'selected' : '' }}>
                                                    Pendidik</option>
                                            </select>
                                            @error('untuk')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="ket" autocomplete="off" class="form-control @error('ket') is-invalid @enderror" rows="3"
                                        id="ket" placeholder="Masukkan Deskripsi Pengumuman secara detail (Hari, tgl. Jam dst.)" required>{{ old('ket') }}</textarea>
                                    @error('ket')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Apakah yakin Pengumuman tentang
                                                            <b>{{ ucwords($data->judul) }}</b> dihapus?</p>
                                                    </div>
