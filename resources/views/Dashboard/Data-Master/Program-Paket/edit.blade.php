            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-warning">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="/admin/program-paket/{{ $cari->id }}">
                            @method('put')
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="kode">Paket <span class="text-danger">*</span></label>
                                    <input autofocus autocomplete="off" value="{{ old('kode', $cari->kode) }}" required
                                        type="text" name="kode"
                                        class="form-control @error('kode') is-invalid @enderror" id="kode"
                                        placeholder="Masukkan Paket (1/2/3/dst)">
                                    @error('kode')
                                ...
                                <div class="form-group">
                                    <label for="program_pilihan">Masukkan Program Kursus <span
                                    ...
                                    <select class="select2" name="program_pilihan[]" id="program_pilihan"
                                        ...
                                        @foreach ($programPilihan as $progPil)
                                            <option value="{{ $progPil->id }}"
                                                {{ in_array($progPil->id, $selectedPrograms) ? 'selected' : '' }}>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="/admin/program-paket"><button type="button"
