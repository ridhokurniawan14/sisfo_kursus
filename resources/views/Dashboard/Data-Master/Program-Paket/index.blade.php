        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="/program-paket">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                      <label for="program_pilihan" class="col-sm-12 col-form-label">Masukkan Program Pilihan<span class="text-danger">*</span></label>
                      <select class="select2" name="program_pilihan[]" id="program_pilihan" multiple="multiple" data-placeholder="Masukkan Program Pilihan" style="width: 100%;">
                          ...
                          @foreach ($program_pilihan as $prog_pil)
                              <option value="{{ $prog_pil->id }}" {{ in_array($prog_pil->id, old('program_pilihan', [])) ? 'selected' : '' }}>
