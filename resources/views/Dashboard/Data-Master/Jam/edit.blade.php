            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-warning">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="/admin/jam/{{ $cari->id }}">
                            @method('put')
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="jam">Jam <span class="text-danger">*</span></label>
                                    <input autocomplete="off" value="{{ old('jam', strtoupper($cari->jam)) }}" required
                                        type="text" name="jam"
                                        class="form-control @error('jam') is-invalid @enderror" id="jam"
                                        placeholder="Masukkan Jam (07.xx Pagi/Malam)">
                                    @error('jam')
                            ...
                            <div class="card-footer">
                                ...
                                <a href="/admin/jam"><button type="button" class="btn btn-secondary">Kembali</button></a>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
