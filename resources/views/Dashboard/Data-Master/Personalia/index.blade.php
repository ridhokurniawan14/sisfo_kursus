                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            ...
                            <a href="/admin/user/create" class="btn btn-primary ml-3 col-sm-2 float-right"><i
                                    class="fas fa-pen nav-icon mr-2"></i>Tambah Admin</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($datas as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->email }}</td>
                                            <td>
                                                <a href="/admin/user/{{ $data->email }}" class="badge bg-info"><span
                                                        class="fas fa-eye"></span></a>
                                                <a href="/admin/user/{{ $data->email }}/edit"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        <form
                                                            action="{{ route('user.destroy', ['user' => $data->email]) }}"
