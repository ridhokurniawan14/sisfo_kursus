            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-warning">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="/admin/user-category/{{ $cari->id }}">
                            @method('put')
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input autofocus autocomplete="off"
                                        value="{{ old('hak_akses', ucwords($cari->hak_akses)) }}" required type="text"
                                        name="hak_akses" class="form-control @error('hak_akses') is-invalid @enderror"
                                        id="hak_akses" placeholder="Masukkan Hak Akses">
                                    @error('hak_akses')
                            ...
                            <div class="card-footer">
                                ...
                                <a href="/admin/user-category"><button type="button"
