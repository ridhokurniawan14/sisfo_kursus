            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="/admin/profil-lembaga/{{ $cari->id }}" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" autofocus
                                                value="{{ old('nm_lembaga', strtoupper($cari->nm_lembaga)) }}" required
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{ old('npsn', ucwords($cari->npsn)) }}"
                                                required type="text" name="npsn"
                                                class="form-control @error('npsn') is-invalid @enderror" id="npsn"
                                                placeholder="NPSN">
                                            @error('npsn')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select name="bentuk" id="bentuk"
                                                ...
                                                <option value="kursus"
                                                    {{ old('bentuk', $cari->bentuk) == 'kursus' ? 'selected' : '' }}>
                                                    Kursus</option>
                                                <option value="pkbm"
                                                    {{ old('bentuk', $cari->bentuk) == 'pkbm' ? 'selected' : '' }}>PKBM
                                                </option>
                                            </select>
                                            @error('bentuk')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select name="sts_lembaga" id="sts_lembaga"
                                                ...
                                                <option value="swasta"
                                                    {{ old('sts_lembaga', $cari->sts_lembaga) == 'swasta' ? 'selected' : '' }}>
                                                    Swasta</option>
                                                <option value="negeri"
                                                    {{ old('sts_lembaga', $cari->sts_lembaga) == 'negeri' ? 'selected' : '' }}>
                                                    Negeri</option>
                                            </select>
                                            @error('sts_lembaga')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="sts" id="sts"
                                                ...
                                                <option value="hak milik"
                                                    {{ old('sts', $cari->sts) == 'hak milik' ? 'selected' : '' }}>Hak
                                                    Milik</option>
                                                <option value="hak guna bangunan"
                                                    {{ old('sts', $cari->sts) == 'hak guna bangunan' ? 'selected' : '' }}>
                                                    Hak Guna Bangunan</option>
                                                <option value="hak guna usaha"
                                                    {{ old('sts', $cari->sts) == 'hak guna usaha' ? 'selected' : '' }}>
                                                    Hak Guna Usaha</option>
                                                <option value="lainnya"
                                                    {{ old('sts', $cari->sts) == 'lainnya' ? 'selected' : '' }}>Lainnya
                                                </option>
                                            </select>
                                            @error('sts')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{ old('sk_izin', $cari->sk_izin) }}"
                                                type="text" name="sk_izin"
                                                class="form-control @error('sk_izin') is-invalid @enderror" id="sk_izin"
                                                placeholder="SK Izin">
                                            @error('sk_izin')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('sk_pendirian', $cari->sk_pendirian) }}" type="text"
                                                name="sk_pendirian"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('tgl_sk_pendirian', $cari->tgl_sk_pendirian) }}"
                                                type="date" name="tgl_sk_pendirian"
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('tgl_sk_izin', $cari->tgl_sk_izin) }}" type="date"
                                                name="tgl_sk_izin"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{ old('alamat', ucwords($cari->alamat)) }}"
                                    ...
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{ old('rt', $cari->rt) }}" required
                                                type="text" name="rt"
                                    ...
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{ old('rw', $cari->rw) }}" required
                                                type="text" name="rw"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{ old('kel', ucwords($cari->kel)) }}"
                                                required type="text" name="kel"
                                ...
                                <div class="row">
                                            ...
                                            <select required name="provinsi"
                                                ...
                                                @foreach ($provinces as $province)
                                                    <option value="{{ $province['name'] }}"
                                                        {{ strtoupper($cari->provinsi) == strtoupper($province['name']) ? 'selected' : '' }}>
                                                        {{ $province['name'] }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{ old('kab', ucwords($cari->kab)) }}"
                                                required type="text" name="kab"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{ old('kec', ucwords($cari->kec)) }}"
                                                required type="text" name="kec"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{ old('kd_pos', ucwords($cari->kd_pos)) }}"
                                                type="text" name="kd_pos"
                                                class="form-control @error('kd_pos') is-invalid @enderror" id="kd_pos"
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{ old('no_tel', ucwords($cari->no_tel)) }}"
                                                required type="text" name="no_tel"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{ old('no_fax', ucwords($cari->no_fax)) }}"
                                                type="text" name="no_fax"
                                                class="form-control @error('no_fax') is-invalid @enderror" id="no_fax"
                                                placeholder="No. Fax">
                                            @error('no_fax')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{ old('email', $cari->email) }}" required
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{ old('web', $cari->web) }}" required
                                                type="text" name="web"
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select name="but_kus"
                                                ...
                                                <option value="ada"
                                                    {{ old('but_kus', $cari->but_kus) == 'ada' ? 'selected' : '' }}>Ada
                                                </option>
                                                <option value="tidak ada"
                                                    {{ old('but_kus', $cari->but_kus) == 'tidak ada' ? 'selected' : '' }}>
                                                    Tidak Ada</option>
                                            </select>
                                            @error('but_kus')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('nm_yayasan', ucwords($cari->nm_yayasan)) }}"
                                                type="text" name="nm_yayasan"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="nm_pajak">Nama Wajib Pajak<span class="text-danger">
                                                    *</span></label>
                                            <input autocomplete="off"
                                                value="{{ old('nm_pajak', strtoupper($cari->nm_pajak)) }}" required
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('no_npwp', ucwords($cari->no_npwp)) }}" required
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('nm_bank', strtoupper($cari->nm_bank)) }}" type="text"
                                                name="nm_bank"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select name="bank_cabang"
                                                ...
                                                <option value="" selected disabled>Pilih opsi</option>
                                                <option value="pusat"
                                                    {{ old('bank_cabang', $cari->bank_cabang) == 'pusat' ? 'selected' : '' }}>
                                                    Pusat</option>
                                                <option value="cabang"
                                                    {{ old('bank_cabang', $cari->bank_cabang) == 'cabang' ? 'selected' : '' }}>
                                                    Cabang</option>
                                                <option value="unit"
                                                    {{ old('bank_cabang', $cari->bank_cabang) == 'unit' ? 'selected' : '' }}>
                                                    Unit</option>
                                            </select>
                                            @error('bank_cabang')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('nm_rekening', strtoupper($cari->nm_rekening)) }}"
                                                type="text" name="nm_rekening"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('luas_tanah', ucwords($cari->luas_tanah)) }}"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required name="kat_lembaga"
                                                ...
                                                <option value="nasional"
                                                    {{ old('kat_lembaga', $cari->kat_lembaga) == 'nasional' ? 'selected' : '' }}>
                                                    Nasional</option>
                                                <option value="internasional"
                                                    {{ old('kat_lembaga', $cari->kat_lembaga) == 'internasional' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('ms_ijin', ucwords($cari->ms_ijin)) }}" type="date"
                                                name="ms_ijin"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('sumber_dana', ucwords($cari->sumber_dana)) }}"
                                                type="text" name="sumber_dana"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('no_sertifikat', ucwords($cari->no_sertifikat)) }}"
                                                type="text" name="no_sertifikat"
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('no_sk_akreditasi', ucwords($cari->no_sk_akreditasi)) }}"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('mulai_berlaku', ucwords($cari->mulai_berlaku)) }}"
                                                type="date" name="mulai_berlaku"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('ms_akreditasi', ucwords($cari->ms_akreditasi)) }}"
                                                type="date" name="ms_akreditasi"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select name="hasil"
                                                ...
                                                <option value="" selected disabled>Pilih opsi</option>
                                                <option value="a"
                                                    {{ old('hasil', $cari->hasil) == 'a' ? 'selected' : '' }}>A</option>
                                                <option value="b"
                                                    {{ old('hasil', $cari->hasil) == 'b' ? 'selected' : '' }}>B</option>
                                                <option value="c"
                                                    {{ old('hasil', $cari->hasil) == 'c' ? 'selected' : '' }}>C</option>
                                                <option value="d"
                                                    {{ old('hasil', $cari->hasil) == 'd' ? 'selected' : '' }}>D</option>
                                                <option value="belum akreditasi"
                                                    {{ old('hasil', $cari->hasil) == 'belum akreditasi' ? 'selected' : '' }}>
                                                    Belum Akreditasi</option>
                                            </select>
                                            @error('hasil')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('penilai', ucwords($cari->penilai)) }}" type="text"
                                                name="penilai"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"
                                                value="{{ old('tgl_sertifikat', ucwords($cari->tgl_sertifikat)) }}"
                                                type="date" name="tgl_sertifikat"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="logo" class="col-sm-9 col-form-label">Logo Lembaga </label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div id="fotoPreview" class="mt-8 col-sm-8 mx-auto d-block">
                                                <input type="hidden" name="oldImage" value="{{ $cari->logo }}">
                                                @if ($cari->logo)
                                                    <img class="img-preview img-fluid mt-8 col-sm-8 mx-auto p-1 d-block"
                                                        src="{{ asset('storage/' . $cari->logo) }}" style="width: 100%;"
                                                        alt="Gambar Lama">
                                                @endif
                                                <img class="img-preview img-fluid mt-8 col-sm-8 mx-auto p-1 d-block"
                                                    style="display: none;">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="/admin/profil-lembaga"><button type="button"
