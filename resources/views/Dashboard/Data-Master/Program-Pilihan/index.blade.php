        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="/program-pilihan">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="program">Program Baru</label>
                    <input autofocus autocomplete="off" value="{{ old('program') }}" required type="text" name="program" class="form-control @error('program') is-invalid @enderror" id="program" placeholder="Masukkan Program">
                    @error('program')
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="/program-pilihan/{{ $data->id }}/edit" class="badge bg-warning"><span class="fas fa-pen"></span></a>
