            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="/admin/program-pilihan">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="program">Program Baru <span class="text-danger">*</span></label>
                                    <input autofocus autocomplete="off" value="{{ old('program') }}" required type="text"
                                ...
                                <tbody>
                                    @foreach ($datas as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/admin/program-pilihan/{{ $data->id }}/edit"
