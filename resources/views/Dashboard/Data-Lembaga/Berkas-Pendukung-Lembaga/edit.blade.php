            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-warning">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="/admin/berkas-akreditasi/{{ $cari->id }}"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <input autofocus autocomplete="off"
                                                value="{{ old('nm_brk', ucwords($cari->nm_brk)) }}" required
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="thn" class="form-control @error('thn') is-invalid @enderror"
                                                ...
                                                @for ($year = date('Y'); $year >= 1990; $year--)
                                                    <option value="{{ $year }}"
                                                        {{ old('thn', $cari->thn) == $year ? 'selected' : '' }}>
                                                        {{ $year }}</option>
                                                @endfor
                                            </select>
                                            @error('thn')
                                    ...
                                    <div id="pdfViewer" class="mt-3 col-sm-6 mx-auto d-block">
                                        @if ($cari->nm_fl)
                                            <embed id="pdfEmbed" src="{{ asset('storage/' . $cari->nm_fl) }}"
                            ...
                            <div class="card-footer">
                                ...
                                <a href="/admin/berkas-akreditasi"><button type="button"
